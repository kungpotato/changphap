                ...
                <Grid item lg={2} style={{ margin: '10px'}}>
                    <Card>
                        ...
                        <div style={{ padding: '20px' }}>
                            <img src="https://material-ui.com/static/images/cards/paella.jpg" alt="" style={{ width: '100%' }} />
                        </div>
                        <CardContent>
                        ...
                        <Grid container>
                            <Grid item lg={6}>
                                <CardActions disableSpacing>
                                    <IconButton aria-label="Add to favorites" style={{ paddingBottom: '0' }}>
                            ...
                            <Grid item lg={6}>
                                <div style={{ marginTop: '22px' }}>
                                    <div>
                                        <Typography style={{ textAlign: 'right', marginRight: '30px' }}>เริ่มต้น </Typography>
                                    </div>
                                    <div>
                                        <Typography style={{ color: '#4EB8A0', textAlign: 'right', marginRight: '30px' }} variant="h6"> 3,500 บาท</Typography>
                                    </div>
                                </div>
                            </Grid>
                        </Grid>
...
export default withRouter(LastProfile)
